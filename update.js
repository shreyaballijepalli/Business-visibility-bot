...
execPhp('/var/www/html/sql.php', function(error, php, outprint){
    ...
    shell.exec('curl -H "Content-Type: application/json" -X POST -u "":"" --data-binary @chat.json "https://gateway.watsonplatform.net/conversation/api/v1/workspaces/?version=2017-05-26"');
});
